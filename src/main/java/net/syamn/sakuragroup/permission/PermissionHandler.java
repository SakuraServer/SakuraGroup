/**
 * SakuraGroup - Package: net.syamn.sakuragroup.permission Created: 2012/10/16
 * 3:40:58
 */
...
public class PermissionHandler {
    ...
    public void setupPermissions(final boolean message) {
         ...
         * 
         * // 一致する権限管理プラグインを取得 上にあるほど高優先度 for (String pname : prefs){ if
         * ("vault".equalsIgnoreCase(pname)){ if (setupVaultPermission()){
         * usePermType = PermType.VAULT; break; } } else if
         * ("pex".equals(pname)){ if (setupPEXPermission()){ usePermType =
         * PermType.PEX; break; } } else if
         * ("superperms".equalsIgnoreCase(pname)){ usePermType =
         * PermType.SUPERPERMS; break; } else if
         * ("ops".equalsIgnoreCase(pname)){ usePermType = PermType.OPS; break; }
         * }
         */
